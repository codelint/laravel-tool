...
class Lunar {
    ...
    public function getFestival($today, $nl_info = false, $config = 1)
    {
        ...
        {
            $arr_lunar = isset($config['lunar']) ? $config['lunar'] : [];
            $arr_solar = isset($config['solar']) ? $config['solar'] : [];
        }
        ...
        $d_lunar = '*-' . substr('0' . $nl_info[5], -2);
        $md_solar = substr_replace($today, '', 0, 5);
        $d_solar = substr_replace($today, '*', 0, 7);
        ...
        isset($arr_lunar[$d_lunar]) ? array_push($festivals, $arr_lunar[$d_lunar]) : '';
        isset($arr_solar[$d_solar]) ? array_push($festivals, $arr_solar[$d_solar]) : '';
